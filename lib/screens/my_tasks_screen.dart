...
//   try {
//     final uri = Uri.parse(
//         '${Backend.baseUrl}/tasks/summary?user_id=${widget.currentUserId}'); // changed provider_id → user_id
...
//                   text: widget.role == "user" ? task.providerName : task.userName,
...
//                 const ClockAndDayBox(),
//                Container(
//   height: MediaQuery.of(context).size.height * 0.3,
//  // approximate height for 2x2 cards
//   child: TaskCardsWidget(
//     toDo: toDo,
...
//                       // Tab views
//                       SizedBox(
//                         height: 500, // adjust according to screen / scroll
//                         child: TabBarView(
//                           children: [
//                             _buildFilteredTasks(
//                               taskProvider,
