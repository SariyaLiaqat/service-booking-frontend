...
//       socket?.emit('user_online', widget.userId);
//     });
...
//     } catch (e) {
//       print("Error marking notifications seen: $e");
//     }
//   }
...
//     try {
//       final url = Uri.parse("${Backend.baseUrl}/notifications/delete/$notifId");
...
//       child: ListTile(
//         leading: Icon(
//           type == 'booking' ? Icons.check_circle : Icons.notifications,
//           color: type == 'booking' ? Colors.green : Colors.blue,
//         ),
//         title: Text(
//           title,
//           maxLines: 1,
