...
class _NotificationsPageState extends State<NotificationsPage> {
  ...
  Color getCardColor(dynamic notif) {
    ...
    return notif['is_seen'] ? MyColors.surface : MyColors.secondary.withOpacity(0.2);
  }
  ...
  Widget buildNotificationCard(dynamic notif) {
    ...
    bool isDarkCard =
        cardColor != MyColors.textPrimary && cardColor != MyColors.textPrimary;
    return Card(
  ...
  decoration: BoxDecoration(
    ...
    gradient: LinearGradient(
      colors: [MyColors.secondary, MyColors.primary], // gold → blue gradient
    ...
    child: (avatar == null || avatar.toString().isEmpty)
        ...
        title: Flexible(
          child: Text(
            ...
            style: TextStyle(
              fontWeight: FontWeight.bold,
              color: isDarkCard ? MyColors.textPrimary : MyColors.textPrimary,
            ),
          ),
        ),
        subtitle: Text(
          ...
          style: TextStyle(
            color: isDarkCard ? MyColors.textSecondary : MyColors.textSecondary,
          ),
        ),
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        actions: [
          IconButton(
            icon: const Icon(Icons.delete_sweep, color: MyColors.textPrimary),
