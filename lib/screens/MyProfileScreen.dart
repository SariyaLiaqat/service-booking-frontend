...
//          (s['description'] != null && s['description'].toString().trim().isNotEmpty) &&
//          (s['category_id'] != null);
// }).toList();
//     try {
...
//     ScaffoldMessenger.of(context)
//         .showSnackBar(const SnackBar(content: Text('Please fill all service fields ❌')));
//     return;
//   }
...
//       // Optional frontend-only skills update
//       if (user['skills'] == null) user['skills'] = [];
//       if (!user['skills'].contains(title)) user['skills'].add(title);
...
//     } else {
//       final error = jsonDecode(response.body)['message'] ?? 'Failed to add service ❌';
...
//         // Description with max 5 lines + scroll if too long
//        Container(
//   height: 100, // fixed height (roughly 4-5 lines)
...
//     overflow: TextOverflow.ellipsis, // "..." for overflow
//   ),
// ),
...
//           'PKR ${s['price'] ?? '-'}',
//           style: const TextStyle(
//             color: Color(0xFF0A66C2), // highlight
//             fontWeight: FontWeight.bold,
//           ),
//         ),
//       ],
