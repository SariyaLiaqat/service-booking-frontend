...
//     debugPrint('✅ DELETE Request sent to: ${Backend.baseUrl}/messages/all');
//     debugPrint('Request body: ${jsonEncode({'user_id': widget.currentUserId})}');
...
//         SnackBar(content: Text('All chats deleted successfully')),
//       );
//     } else {
//       // Server ka error message bhi show karo
//       String errorMessage = response.body.isNotEmpty
//           ? response.body
//           : 'Unknown error from server';
//       ScaffoldMessenger.of(context).showSnackBar(
//         SnackBar(content: Text('Failed to delete chats: $errorMessage')),
//       );
//     }
//   } catch (e, stackTrace) {
//     debugPrint('❌ Exception deleting all chats: $e');
//     debugPrint('StackTrace: $stackTrace');
//     ScaffoldMessenger.of(context).showSnackBar(
//       SnackBar(content: Text('Error deleting chats: $e')),
//     );
//   }
// }
...
//                                       final url = Uri.parse(
//                                         '${Backend.baseUrl}/messages/conversation/$convoId',
//                                       );
//                                       final response = await http.delete(
//                                         url,
//                                         headers: {
...
//       onPressed: () {
//         // ✅ Jab click ho, chatbot page open hoga
//         Navigator.push(
//           context,
...
import '../models/animated_ai_chat_button.dart'; // Make sure path is correct
// ✅ SocketManager import
import 'chatbot.dart';
...
class _MessagesTabState extends State<MessagesTab> {
                    ...
                    if (selected == 'delete_all') {
                      ...
                      if (confirm == true) {
                        try {
                          ...
                          debugPrint(
                            '✅ DELETE Request sent to: ${Backend.baseUrl}/messages/all',
                          );
                          debugPrint(
                            'Request body: ${jsonEncode({'user_id': widget.currentUserId})}',
                          );
                          debugPrint('Response Code: ${response.statusCode}');
                          debugPrint('Response Body: ${response.body}');
                          ...
                          if (response.statusCode == 200) {
                            ...
                            ScaffoldMessenger.of(context).showSnackBar(
                              SnackBar(
                                content: Text(
                                  'Failed to delete chats: $errorMessage',
                                ),
                              ),
                            );
                          }
  ...
  child: Container(
    ...
    decoration: BoxDecoration(
      color: kCardColor,
      borderRadius: BorderRadius.circular(12),  // smooth rounded
      boxShadow: [
        BoxShadow(
    ...
    child: Row(
      children: [
        ...
        const Icon(Icons.search, size: 22, color: kTextSecondary),
                                    ...
                                    return Dismissible(
                                      ...
                                      child: GestureDetector(
                                        onTap: () async {
                                          ...
                                          widget.onConversationSeen?.call(
                                            convoId,
                                          );
                                        },
